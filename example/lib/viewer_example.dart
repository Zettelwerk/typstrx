...
/// Full-page example: a [TypstCodeEditor] on the left and a [TypstViewer]
/// (with its rasterization tuning panel) on the right.
class ViewerExamplePage extends StatefulWidget {
  const ViewerExamplePage({
    super.key,
  ...
  @override
  State<ViewerExamplePage> createState() => _ViewerExamplePageState();
}

class _ViewerExamplePageState extends State<ViewerExamplePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('typstrx example — editor + full-page viewer'),
        actions: [
          IconButton(
